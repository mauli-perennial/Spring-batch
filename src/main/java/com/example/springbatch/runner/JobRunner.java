...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job student, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        jobParametersBuilder.addString(Constants.FILE_NAME_CONTEXT_KEY, "student.csv");
        jobParametersBuilder.addDate("date", new Date(), true);
        runJob(student, jobParametersBuilder.toJobParameters());
    }
